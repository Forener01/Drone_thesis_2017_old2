...
int main(int argc, char** argv)
{
  ...
  while (ros::ok())
  {
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 1.0");
      myPath.takeoff = true;
      myPath.publish_poseref();
    }
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 2.0");
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 3.0");
      myPath.takeoff = true;
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 4.0");
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 5.0");
      myPath.takeoff = true;
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 6.0");
      myPath.next_z = 2;
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 7.0");
    ...
    {
      ROS_INFO("myPath.lastStrategyReceived.type == 8.0");
      myPath.takeoff = true;
