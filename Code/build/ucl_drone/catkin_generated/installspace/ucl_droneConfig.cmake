...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ucl_drone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aurian/Bureau/Drone_thesis_2017/Code/install/${idir}'.  Ask the maintainer 'dronesinma <drones-inma@uclouvain.be>' to fix it.")
    endif()
