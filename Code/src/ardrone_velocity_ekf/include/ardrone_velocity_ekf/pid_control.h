...
public:
  ...
  void pid_control();
  void run();
  void i_term_set(double &i_value, double error, double vel, double old_vel,
                  double wind_up, double dt);
  void set_hover(void);
...
private:
  ...
  dynamic_reconfigure::Server<ardrone_velocity_ekf::dynamic_param_configConfig>
      m_server;
